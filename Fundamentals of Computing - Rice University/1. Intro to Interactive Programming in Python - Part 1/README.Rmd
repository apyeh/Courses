...
More information about the course and a verified certificate of course completion with distinction can be found [here](https://www.coursera.org/account/accomplishments/records/83pAumRNgjY6XYtS)

## Mini Projects

Below are the brief mini project descriptions as described by the course instructors.

**Important**: Programs need to be opened and run in the CodeSkulptor environment at http://www.codeskulptor.org to work properly
